...
public class DeviceUtils {
    ...
    public static int[] getNotchSize(Context context) {
        ...
        try {
            ...
            Log.i("test", "getNotchSize ClassNotFoundException");
        } catch (NoSuchMethodException e) {
            Log.i("test", "getNotchSize NoSuchMethodException");
        } catch (Exception e) {
            Log.i("test", "getNotchSize Exception");
        } finally {
            return ret;
        }
    }
    ...
    public static String getAppMetaData(String key) {
        ...
        try {
            ...
            if (packageManager != null) {
                ApplicationInfo applicationInfo = packageManager.getApplicationInfo(AppUtils.getContext().getPackageName(), PackageManager.GET_META_DATA);
    ...
    public static boolean isTabletDevice() {
        return (AppUtils.getContext().getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK) >= Configuration.SCREENLAYOUT_SIZE_LARGE;
    }
    ...
    public static String getIntervalMemorySize(){
        ...
        return Formatter.formatFileSize(AppUtils.getContext(), size);
    }
    ...
    public static String getAvailableInternalMemorySize(){
        ...
        long blockSizeLong = statFs.getBlockSizeLong();
        return Formatter.formatFileSize(AppUtils.getContext(), availableBlocksLong
                * blockSizeLong);
    }
    ...
    public static String getExternalMemorySize(){
        ...
        long blockCountLong = statFs.getBlockCountLong();
        return Formatter
                .formatFileSize(AppUtils.getContext(), blockCountLong * blockSizeLong);
    }
    ...
    public static int getVersionCode(){
        PackageManager manager = AppUtils.getContext().getPackageManager();
        int code = 0;
        try{
            PackageInfo info = manager.getPackageInfo(AppUtils.getContext().getPackageName(), 0);
    ...
    public static String getAppName(){
        ...
        try{
            PackageManager packageManager = AppUtils.getContext().getPackageManager();
            ApplicationInfo info = AppUtils.getContext().getApplicationInfo();
    ...
    public static String getDeviceId(){
        ...
        TelephonyManager telephonyManager = (TelephonyManager) AppUtils.getContext()
        ...
        if (TextUtils.isEmpty(strResult)) {
            strResult = Settings.Secure.getString(AppUtils.getContext().getContentResolver(),
    ...
    public static String getWifiMac() {
        WifiManager wifiManager = (WifiManager) AppUtils.getContext().getApplicationContext()
